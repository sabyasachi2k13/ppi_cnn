...
class SiameseNetwork(nn.Module):
    def __init__(self):
        ...
        self.cnn1 = nn.Conv2d(20, 64, kernel_size=(1,3), stride=(1,1),padding=(0,2))
        ...
        self.cnn2 = nn.Conv2d(64,128, kernel_size=(1,3), stride=(1,1),padding=(0,2))
        self.bn2 =  nn.BatchNorm2d(128)
        self.act2 = nn.ReLU(inplace=True)
        self.pool2 = nn.AvgPool2d(kernel_size=(1,4), stride=(1,4),padding=(0,0))

        self.cnn3 = nn.Conv2d(128, 256, kernel_size=(1,3), stride=(1,1),padding=(0,2))
        ...
        self.cnn4 = nn.Conv2d(256, 512,kernel_size=(1,3), stride=(1,1),padding=(0,2))
...
def train(criterion,optimizer,net,train_loader,epoch,batchsize,device):
    ...
    for i,data in enumerate(train_loader):
            ...
            weights = [3 if a_ == 1 else 1 for a_ in labels]
