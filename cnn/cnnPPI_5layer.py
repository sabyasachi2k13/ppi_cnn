...
class SiameseNetwork(nn.Module):
    def __init__(self):
        ...
        self.cnn1 = nn.Conv2d(20, 32, kernel_size=(1,3), stride=(1,1),padding=(0,2))
        ...
        self.cnn2 = nn.Conv2d(32,64,kernel_size=(1,3),stride=(1,1),padding=(0,2))
        self.bn2 = nn.BatchNorm2d(64)
        self.act2 = nn.ReLU(inplace=True)
        self.pool2 = nn.AvgPool2d(kernel_size=(1,4) , stride=(1,4),padding=(0,2) )

        self.cnn3 = nn.Conv2d(64,128, kernel_size=(1,5), stride=(1,1),padding=(0,2))
        self.bn3 =  nn.BatchNorm2d(128)
        self.act3 = nn.ReLU(inplace=True)
        self.pool3 = nn.AvgPool2d(kernel_size=(1,4), stride=(1,4),padding=(0,0))

        self.cnn4 = nn.Conv2d(128, 256, kernel_size=(1,5), stride=(1,1),padding=(0,2))
        self.bn4 =  nn.BatchNorm2d(256)
        self.act4 = nn.ReLU(inplace=True)
        self.pool4 = nn.AvgPool2d(kernel_size=(1,4), stride=(1,4),padding=(0,0))

        #torch.Size([1, 128, 1, 32])
        #self.lstm2 = LSTMModel(128, 64, 2, 128)
            
        self.cnn5 = nn.Conv2d(256, 512,kernel_size=(1,5), stride=(1,1),padding=(0,2))
        self.bn5 =  nn.BatchNorm2d(512)
        self.act5 =  nn.ReLU(inplace=True)
        self.pool5= nn.AvgPool2d(kernel_size=(1,2), stride=(1,2),padding=(0,0))
